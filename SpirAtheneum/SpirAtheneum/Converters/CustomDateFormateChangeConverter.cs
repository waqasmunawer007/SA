...
{
    class CustomDateFormateChangeConverter : IValueConverter
    {
        ...
        public string DateTimeCustmization(string date)
        {
            ...
            int month = Int32.Parse(DateTimeSplits[0]);
            int day = Int32.Parse(DateTimeSplits[1]);
            int year = Int32.Parse(DateTimeSplits[2]);
